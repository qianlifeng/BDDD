...
namespace BDDD.Repository
{
    ...
    public interface IRepository<TAggregateRoot> where TAggregateRoot : class
    {
        ...
        IEnumerable<TAggregateRoot> GetAll(ISpecification<TAggregateRoot> specification, int pageNumber, int pageSize,
                                           Expression<Func<TAggregateRoot, object>> sortPredicate, SortOrder sortOrder);
        ...
        /// <param name="sortPredicate">排序属性</param>
        /// <returns></returns>
        IEnumerable<TAggregateRoot> GetAll(Expression<Func<TAggregateRoot, bool>> specification, int pageNumber,
